...
info_all = collection.getElementsByTagName("info")

# Print detail of each info.
for info in info_all:
   genere = info.getElementsByTagName('genere')[0]
   #print ("Genere: %s" % genere.childNodes[0].data)
   sentence = info.getElementsByTagName('sentence')[0]
   #print ("Sentence: %s" % sentence.childNodes[0].data)
   training_data.append({"class": genere.childNodes[0].data, "sentence": sentence.childNodes[0].data})
